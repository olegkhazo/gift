...
const productImages = [
  {
    ...
    alt: 'Simple package',
    title: 'Simple',
    description: 'A straightforward, no-frills delivery — the classic way to send a crappy gift.',
  },
  {
    id: 2,
    ...
    alt: 'Special package',
    title: 'Special',
    description: 'A step up from ordinary — delivered with extra flair and a personal touch.',
  },
  {
    id: 3,
    ...
    alt: 'Premium package',
    title: 'Premium',
    description: 'The full experience — premium presentation for the gift that keeps on stinking.',
  },
]
